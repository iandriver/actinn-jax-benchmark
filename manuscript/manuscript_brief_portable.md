...
models [\[Kalfon 2025\]](https://doi.org/10.1038/s41467-025-58699-1) raise accuracy in some settings but need accelerators, and used zero-shot
they underperform far simpler alternatives, here (0.201 against 0.917 ontology concordance on
lung) and in an independent evaluation of scGPT and Geneformer embeddings [\[Kedzierska 2025\]](https://doi.org/10.1186/s13059-025-03574-x).
