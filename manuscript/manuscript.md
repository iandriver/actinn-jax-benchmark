...
- **Pan-human Azimuth** ([Sarkar et al. 2026]) is a supervised hierarchical classifier over a
  ...
  [`panhuman_adapter.py`](https://github.com/iandriver/actinn-jax-benchmark/blob/main/benchmark/adapters/panhuman_adapter.py).
...
vocabulary and the hierarchy from an existing pretrained annotator. Keras/TensorFlow and JAX cannot share a process,
...
force-labeled (see the smooth abstain curve of §3.5). This is the
...
([`results_hierarchy_ablation.csv`](https://github.com/iandriver/actinn-jax-benchmark/blob/main/docs/results_hierarchy_ablation.csv)):
...
9. Edgar R, et al. The Human Liver Cell Atlas (HLiCA). *bioRxiv* (2026). [doi:10.\allowbreak{}64898/\allowbreak{}2026.\allowbreak{}06.\allowbreak{}30.\allowbreak{}735539](https://doi.org/10.64898/2026.06.30.735539).
...
12. Kalfon J, Samaran J, Peyré G, Cantini L. scPRINT: pre-training on 50 million cells allows robust gene network predictions. *Nature Communications* (2025). [doi:10.\allowbreak{}1038/\allowbreak{}s41467-025-58699-1](https://doi.org/10.1038/s41467-025-58699-1).
...
19. Rosen Y, et al. Universal cell embeddings: a foundation model for cell biology (UCE). *Nature* (2026). [doi:10.\allowbreak{}1038/\allowbreak{}s41586-026-10689-z](https://doi.org/10.1038/s41586-026-10689-z).
