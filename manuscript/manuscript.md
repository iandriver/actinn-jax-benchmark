...
a real atlas (§5, S3), while scTOP is built for small,
...
force-labeled (S9, and the smooth abstain curve of §3.5). This is the
...
the *same cells* reaches **0.72 / 0.86** (S11,
S12). Refinement is where fine-grained accuracy comes
