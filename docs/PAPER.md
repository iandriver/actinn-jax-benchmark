...
**Those same four methods differ by ~260× in inference time** (0.34 s to 89 s) **and 2.4× in
...
behavior from 3k to 49k reference cells), then use actinn-jax to demonstrate **end-to-end
