...
deep-probabilistic, prototype-VAE and foundation-model — across **eight splits of seven
datasets** (8–151 cell types; within-dataset, cross-dataset and cross-study) on commodity hardware, and
